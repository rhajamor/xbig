...
<xsl:stylesheet version="2.0"
			...
			<xsl:element name="typeparameters">
				<xsl:for-each select="$template/templateparameters/templateparameter
					...
					<xsl:element name="typepara">
						...
						<xsl:attribute name="used" select="$resolvedTypeParas/para[$pos]"/>
					</xsl:element>
				</xsl:for-each>
			</xsl:element>
	...
	<xsl:template name="createVariableElement">
		...
		<xsl:element name="variable">
			...
			<xsl:attribute name="visibility" select="$variable/@visibility"/>
	...
	<xsl:template name="createFunctionElement">
		...
		<xsl:element name="function">
          	...
          	<xsl:attribute name="visibility" select="$function/@visibility"/>
			...
			<xsl:attribute name="isGeneratedForTemplate" select="'true'"/>
			...
			<xsl:if test="$function/parameters">
				<xsl:element name="parameters">
					<xsl:for-each select="$function/parameters/parameter">
